Shader "M2U/Beast-RT Lighting/Opaque/Flat/Specular"
{
Properties
{
...
void main ()
{
  ...
  highp float tmpvar_17;
  tmpvar_17 = (pow (nh_13, arg1_16) * tmpvar_4);
  highp vec3 tmpvar_18;
  tmpvar_18 = ((((tmpvar_2 * _LightColor0.xyz) * tmpvar_14) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_17)) * 2.0);
  c_12.xyz = tmpvar_18;
  highp float tmpvar_19;
...
void main ()
{
  ...
  tmpvar_22 = (((lm_16 * _SpecColor.xyz) * tmpvar_4) * tmpvar_20);
  ...
  tmpvar_24 = (c_1.xyz + (tmpvar_2 * tmpvar_11.xyz));
  c_1.xyz = tmpvar_24;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  mediump vec3 lm_18;
  lowp vec3 tmpvar_19;
  tmpvar_19 = ((8.0 * tmpvar_10.w) * tmpvar_10.xyz);
  lm_18 = tmpvar_19;
  lowp vec3 tmpvar_20;
  tmpvar_20 = ((8.0 * tmpvar_11.w) * tmpvar_11.xyz);
...
void main ()
{
  ...
  highp vec3 tmpvar_24;
  tmpvar_24 = ((((tmpvar_2 * _LightColor0.xyz) * tmpvar_20) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_23)) * (tmpvar_10 * 2.0));
  c_18.xyz = tmpvar_24;
  highp float tmpvar_25;
  tmpvar_25 = (((_LightColor0.w * _SpecColor.w) * tmpvar_23) * tmpvar_10);
  c_18.w = tmpvar_25;
  c_1.w = c_18.w;
...
void main ()
{
  ...
  highp float tmpvar_18;
  tmpvar_18 = (pow (nh_14, arg1_17) * tmpvar_4);
  highp vec3 tmpvar_19;
  tmpvar_19 = ((((tmpvar_2 * _LightColor0.xyz) * tmpvar_15) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_18)) * (tmpvar_10.x * 2.0));
  c_13.xyz = tmpvar_19;
  highp float tmpvar_20;
  tmpvar_20 = (((_LightColor0.w * _SpecColor.w) * tmpvar_18) * tmpvar_10.x);
  c_13.w = tmpvar_20;
  c_1.w = c_13.w;
...
void main ()
{
  ...
  tmpvar_28 = (((lm_22 * _SpecColor.xyz) * tmpvar_4) * tmpvar_26);
  ...
  lowp vec3 tmpvar_30;
  tmpvar_30 = vec3((tmpvar_10 * 2.0));
  mediump vec3 tmpvar_31;
  tmpvar_31 = (c_1.xyz + (tmpvar_2 * min (tmpvar_17.xyz, tmpvar_30)));
  c_1.xyz = tmpvar_31;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_25 = (((lm_19 * _SpecColor.xyz) * tmpvar_4) * tmpvar_23);
  ...
  lowp vec3 arg1_27;
  arg1_27 = ((tmpvar_10.x * 2.0) * tmpvar_11.xyz);
  mediump vec3 tmpvar_28;
  tmpvar_28 = (c_1.xyz + (tmpvar_2 * max (min (tmpvar_14.xyz, arg1_27), (tmpvar_14.xyz * tmpvar_10.x))));
  c_1.xyz = tmpvar_28;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  highp vec3 tmpvar_21;
  tmpvar_21 = ((((tmpvar_2 * _LightColor0.xyz) * tmpvar_17) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_20)) * (shadow_10 * 2.0));
  c_15.xyz = tmpvar_21;
  highp float tmpvar_22;
  tmpvar_22 = (((_LightColor0.w * _SpecColor.w) * tmpvar_20) * shadow_10);
  c_15.w = tmpvar_22;
  c_1.w = c_15.w;
...
void main ()
{
  ...
  c_1.xyz = specColor_16;
  lowp vec3 tmpvar_27;
  tmpvar_27 = vec3((shadow_10 * 2.0));
  mediump vec3 tmpvar_28;
  tmpvar_28 = (c_1.xyz + (tmpvar_2 * min (tmpvar_14.xyz, tmpvar_27)));
  c_1.xyz = tmpvar_28;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
}
...
RSQ R0.w, R0.w;
MAD R2.xyz, R0.w, fragment.texcoord[3], c[0];
DP3 R0.w, R2, R2;
RSQ R0.w, R0.w;
MUL R2.xyz, R0.w, R2;
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedbbifccmpbbnfdjgloifaaonihfdmlemfabaaaaaafeaeaaaaadaaaaaa
...
aaaaaaaadkaabaaaabaaaaaabaaaaaaibcaabaaaaaaaaaaaegbcbaaaacaaaaaa
...
egiccaaaaaaaaaaaadaaaaaadiaaaaaihcaabaaaacaaaaaaegacbaaaabaaaaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiecedajpaaiboiippooobglgefpbeoeccpfkdabaaaaaaheagaaaaaeaaaaaa
daaaaaaaemacaaaakaafaaaaeaagaaaaebgpgodjbeacaaaabeacaaaaaaacpppp
neabaaaaeaaaaaaaacaaciaaaaaaeaaaaaaaeaaaabaaceaaaaaaeaaaaaaaaaaa
...

...
diaaaaahocaabaaaaaaaaaaaagaabaaaaaaaaaaaagajbaaaabaaaaaadiaaaaah
iccabaaaaaaaaaaaakaabaaaaaaaaaaadkaabaaaabaaaaaabaaaaaaibcaabaaa
...
aaaaaaaaegacbaaaacaaaaaaagaabaaaaaaaaaaajgahbaaaaaaaaaaaaaaaaaah
hcaabaaaaaaaaaaaegacbaaaaaaaaaaaegacbaaaaaaaaaaadcaaaaajhccabaaa
aaaaaaaaegacbaaaabaaaaaaegbcbaaaadaaaaaaegacbaaaaaaaaaaadoaaaaab
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiecedmclcdhjbnmoednloefmkmnoaolahckldabaaaaaadeadaaaaaeaaaaaa
...
MUL R1.xyz, R1, c[4].y;
MUL R3.xyz, R1.y, c[6];
MAD R3.xyz, R1.x, c[4].zxww, R3;
MAD R1.xyz, R1.z, c[5], R3;
DP3 R1.w, R1, R1;
RSQ R2.w, R1.w;
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedmekkgionldfdfnbaehejjpgncmcilhecabaaaaaabmafaaaaadaaaaaa
...
adaaaaaaadaaahacabaaaaaaacaaaaaaafaaaaoeabaaaaaa mul r3.xyz, r1.x, c5
abaaaaaaaaaaahacadaaaakeacaaaaaaaaaaaakeacaaaaaa add r0.xyz, r3.xyzz, r0.xyzz
adaaaaaaadaaahacabaaaakkacaaaaaaagaaaaoeabaaaaaa mul r3.xyz, r1.z, c6
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiec
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiecedlijieedchjlaajaalhgnjeagkcaaodnoabaaaaaageajaaaaaeaaaaaa
daaaaaaagiadaaaajaaiaaaadaajaaaaebgpgodjdaadaaaadaadaaaaaaacpppp
oeacaaaaemaaaaaaacaadeaaaaaaemaaaaaaemaaaeaaceaaaaaaemaaabaaaaaa
...

...
aaaaaaaaakaabaaaaaaaaaaaaoaaaaahgcaabaaaaaaaaaaaagbbbaaaadaaaaaa
pgbpbaaaadaaaaaaefaaaaajpcaabaaaabaaaaaajgafbaaaaaaaaaaaeghobaaa
abaaaaaaaagabaaaaaaaaaaaaaaaaaahccaabaaaaaaaaaaaakaabaaaabaaaaaa
...
hcaabaaaacaaaaaaagaabaaaabaaaaaajgahbaaaabaaaaaadiaaaaaihcaabaaa
abaaaaaajgahbaaaabaaaaaaegiccaaaaaaaaaaaacaaaaaadiaaaaaihcaabaaa
abaaaaaaegacbaaaabaaaaaafgifcaaaaaaaaaaaaiaaaaaadeaaaaahocaabaaa
...
void main ()
{
  ...
  lowp float spec_15;
  mediump float tmpvar_16;
  tmpvar_16 = (tmpvar_12.w * tmpvar_5);
  spec_15 = tmpvar_16;
  mediump vec3 tmpvar_17;
  tmpvar_17 = ((tmpvar_4 * light_3.xyz) + ((light_3.xyz * _SpecColor.xyz) * spec_15));
  c_14.xyz = tmpvar_17;
  c_14.w = (spec_15 * _SpecColor.w);
  c_2 = c_14;
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  lowp float spec_20;
  mediump float tmpvar_21;
  tmpvar_21 = (tmpvar_15.w * tmpvar_8);
  spec_20 = tmpvar_21;
  mediump vec3 tmpvar_22;
  tmpvar_22 = ((tmpvar_7 * light_6.xyz) + ((light_6.xyz * _SpecColor.xyz) * spec_20));
  c_19.xyz = tmpvar_22;
...
void main ()
{
  ...
  tmpvar_27 = (tmpvar_24.w * tmpvar_6);
  spec_26 = tmpvar_27;
  mediump vec3 tmpvar_28;
  tmpvar_28 = ((tmpvar_4 * tmpvar_24.xyz) + ((tmpvar_24.xyz * _SpecColor.xyz) * spec_26));
  c_25.xyz = tmpvar_28;
...
void main ()
{
  ...
  mediump vec3 lm_20;
  lowp vec3 tmpvar_21;
  tmpvar_21 = ((8.0 * tmpvar_13.w) * tmpvar_13.xyz);
  lm_20 = tmpvar_21;
  lowp vec3 tmpvar_22;
  tmpvar_22 = ((8.0 * tmpvar_14.w) * tmpvar_14.xyz);
...
//   d3d11 - ALU: 7 to 26, TEX: 2 to 4, FLOW: 1 to 1
//   d3d11_9x - ALU: 7 to 26, TEX: 2 to 4, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
Vector 0 [_SpecColor]
Vector 1 [_Color]
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedepnhkdhmofmhgknlnafglenokoodbgpgabaaaaaaniacaaaaadaaaaaa
cmaaaaaaleaaaaaaoiaaaaaaejfdeheoiaaaaaaaaeaaaaaaaiaaaaaagiaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaaheaaaaaaaaaaaaaaaaaaaaaa
...
ebaaaaaaabaaaaaaegbcbaaaadaaaaaadiaaaaajicaabaaaaaaaaaaadkaabaia
ebaaaaaaabaaaaaabkiacaaaaaaaaaaaaeaaaaaadiaaaaaihcaabaaaacaaaaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiec